...
negStrongUnlinkability =  (K (UAg spy) (existsName [VarName "y1", VarName "y2"] (forAllHonest [VarAg "x"] (Link (UVarAg "x") (Role T, VarAg "x") `imp` (Link (UVarAg "x") (Self, VarName "y1") ∨ Link (UVarAg "x") (Self, VarName "y2") )) ) ))
